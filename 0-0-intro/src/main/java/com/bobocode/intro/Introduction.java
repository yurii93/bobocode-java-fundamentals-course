 ...
 * <p>
 * Every exercise is covered with test. So when you're implementing some class like {@link Introduction}, you should
 * also be able to find a corresponding class IntroductionTest
 */
public class Introduction {
    /**
     * Throughout the course you will need to implement hundreds of methods. And this is a simple example of how it's
     * all organized. You read the Java Doc, implement a method and run the test.
     *
